...
const Cards = () => {
  ...
  return (
    data.map(item => {
      return (
        <ReactBootstrap.Card key={`card__${item.id}`} className={`card__${item.id} col-sm-3`}>
          <ReactBootstrap.Card.Body className='d-flex flex-column justify-content-center align-items-center'>
            ...
            <ReactBootstrap.Image className='' alt='background dots' src='./src/images/bg-dots.svg' />
            <Button variant='primary' className='p-2 mt-3' content='Add & Install Extension' />
